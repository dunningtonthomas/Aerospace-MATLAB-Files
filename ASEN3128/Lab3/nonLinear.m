...
%% Plotting
%Roll variation
controlTemp = zeros(length(timeRoll), 4);
PlotAircraftSim(timeRoll, finalStateRoll, controlTemp, 1:6, '-');


%Pitch variation
controlTemp = zeros(length(timePitch), 4);
PlotAircraftSim(timePitch, finalStatePitch, controlTemp, 7:12, '-');


%Yaw variation
controlTemp = zeros(length(timeYaw), 4);
PlotAircraftSim(timeYaw, finalStateYaw, controlTemp, 13:18, '-');
