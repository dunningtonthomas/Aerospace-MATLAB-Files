function [observable, elevationAngle, cameraAngle] = checkView2(r, targets, F, V, N)
%CHECK_VIEW
...
%   targets - vector of indices of the targets
...
%SAME AS CHECK VIEW BUT ONLY ACCOUNTS FOR THE TARGET FACETS
