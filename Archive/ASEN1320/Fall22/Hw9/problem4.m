...
%%% plot results
PlotAircraftSim(TOUT,YOUT,UOUT,'b', wind_inertial)
...
%%% plot results
PlotAircraftSim(TOUT,YOUT,UOUT,'k', wind_inertial)
...
%%% plot results
PlotAircraftSim(TOUT,YOUT,UOUT,'r', wind_inertial)
% 
%% 4d
...
extraAngle = asin(norm(wind_inertial)*(sind(15)/airSpeed)); % in rad
trimYaw = extraAngle + 60*(pi/180);
...
%%% plot results
PlotAircraftSim(TOUT,YOUT,UOUT,'m', wind_inertial)
