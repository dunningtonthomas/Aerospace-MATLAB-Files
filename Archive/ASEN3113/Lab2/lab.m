...
%Finding percent error between the analytical and experimental data
%Real - estimate / real
errorAlum26 = (abs(H_an_Alum_1 - H_alum26) / H_alum26) * 100;
errorAlum28 = (abs(H_an_Alum_2 - H_alum28) / H_alum28) * 100;
errorBrass26 = (abs(H_an_Brass_1 - H_brass26) / H_brass26) * 100;
errorBrass29 = (abs(H_an_Brass_2 - H_brass29) / H_brass29) * 100;
errorSteel = (abs(H_an_Steel - H_steel) / H_steel) * 100;
