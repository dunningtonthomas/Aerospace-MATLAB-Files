# 1 "C:/Users/Thomas/Desktop/Microavionics/lab01_part04.asm"
# 1 "<built-in>" 1
# 1 "C:/Users/Thomas/Desktop/Microavionics/lab01_part04.asm" 2
...
;
; Hardware Notes:
# 117 "C:/Users/Thomas/Desktop/Microavionics/lab01_part04.asm"
...
# 129 "C:/Users/Thomas/Desktop/Microavionics/lab01_part04.asm" 2
...
CONFIG BOREN = ON ; Brown Out Detect (Controlled with ((RCON) and 0FFh), 6, a bit)
...
CONFIG WDTEN = OFF ; Watchdog Timer (WDT disabled in hardware;
         ; ((WDTCON) and 0FFh), 0, a bit disabled)
...
CONFIG ECCPMX = PORTE ; ECCP Mux (Enhanced ((PORTC) and 0FFh), 2, a/3 [((PORTE) and 0FFh), 6, a/((PORTE) and 0FFh), 5, a/((PORTE) and 0FFh), 4, a/((PORTE) and 0FFh), 3, a]
         ; muxed with ((PORTE) and 0FFh), 6, a/((PORTE) and 0FFh), 5, a/((PORTE) and 0FFh), 4, a/((PORTE) and 0FFh), 3, a)
; CONFIG MSSPMSK = ((SSP1ADD) and 0FFh), 7, a ; MSSP address masking (7 Bit address masking
         ; mode)
...
loop:
    ...
    ANDLW 00001000B ; Bitwise AND operation to isolate ((PORTD) and 0FFh), 3, a
    BZ SWT_ON ; Branch if switch is on
    BCF LATB, 7, a ; Otherwise turn LED ((PORTB) and 0FFh), 7, a off
    BRA RB7_OFF ; Branch to RB7_OFF to leave ((PORTB) and 0FFh), 7, a off and restart instruction sequence
SWT_ON:
    BSF LATB, 7, a ; Turn LED ((PORTB) and 0FFh), 7, a on
RB7_OFF:
    BRA loop
