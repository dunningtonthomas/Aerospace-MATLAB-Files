...
%save("RRTWaypointPath.mat", "aircraft_array", "time_iter", "control_array", "desired_waypoints");
...
plot(x_spline, spline_waypoints, 'linewidth', 2, 'LineStyle', '--', 'color', 'm', 'DisplayName', 'Spline Fit');
...
% Add a proxy line for tolerance circles in the legend
plot(NaN, NaN, 'r--', 'LineWidth', 1.5, 'DisplayName', 'Tolerance Bound');

% Formatting the plot
xlabel('East (m)', 'FontSize', 12, 'FontWeight', 'bold');
ylabel('North (m)', 'FontSize', 12, 'FontWeight', 'bold');
title('Autopilot Waypoint Tracking', 'FontSize', 14, 'FontWeight', 'bold');
axis equal;
grid on;
