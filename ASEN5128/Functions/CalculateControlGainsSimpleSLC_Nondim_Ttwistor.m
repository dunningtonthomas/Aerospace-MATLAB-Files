...
control_gains.Ki_roll = -0.6; %%%<---------- STUDENT SELECT
...
%%%%%%%
% course hold gains
wn_chi = (1/50)*wn_roll; %%%<---------- STUDENT SELECT
...
control_gains.Kd_beta = 1; %%%<---------- STUDENT SELECT NOT USED IN SIDESLIP HOLD AUTOPILOT
...
wn_height = (1/100)*wn_pitch; %%%<---------- STUDENT SELECT
zeta_height = 0.8; %%%<---------- STUDENT SELECT
...
wn_airspeed = (1/50)*wn_pitch; %%%<---------- STUDENT SELECT
zeta_airspeed = 2; %%%<---------- STUDENT SELECT
