...
% STUDENTS Uncomment the section below once the autopilot is tuned
% and you can see an animation of the behavior. It is slow so you dont want
% to run it every time while tuning the autopilot.
%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
